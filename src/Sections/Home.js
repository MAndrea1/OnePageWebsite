...
const Home = () => {
    return (
        <section className='section relative flex items-center justify-center text-center' id='home'>
            <div className='relative z-30 p-5 sm:h-auto text-gray-600 bg-gray-50 bg-opacity-50 rounded-sm -mt-12'>
                <h1 className='relative text-3xl'>A title for this website</h1>
                <p>A subtitle for this website</p>
                <a href='#about'><button className='btn bg-white rounded-xl py-2 w-40 mt-5 animate-bounce hover:bg-yellow-800 hover:text-yellow-300 transition duration-200 ease-in-out'></button></a>
            </div>
